  ...
  const renderExplanation = useCallback(
    () => (
      <>
        ...
        <p>
          The primary purpose of Base64 encoding is to represent binary data in
          a format that is safe for transport and storage in text-based systems,
        ...
        <ol>
          <li>
            Email Attachments: Binary files (e.g., images or documents) are
            often Base64-encoded when included as attachments in email messages.
          </li>

          <li>
            Data URLs: In web development, Base64 encoding is sometimes used to
            embed small images or other resources directly into HTML or CSS
            files using data URLs.
          </li>
        ...
        <p>
          ...
          character in the Base64 character set. These chunks are combined to
          form the Base64-encoded string. Decoding is the reverse process, where
        ...
        <p>
          Original binary data: <code>01001001 00110010 00111000</code> (24
          bits)
        </p>
        ...
        <p>
          ...
          encryption or security. The purpose is primarily to ensure
          compatibility with text-based systems that may not handle binary data
          well.
        </p>
      </>
    ),
